...
- Upgraded Kysely to 0.29, replaced the stale Bun SQLite dialect dependency with Kysely's built-in SQLite driver adapter, and propagated request cancellation to database queries
